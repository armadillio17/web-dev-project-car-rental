	...
	<div class="contact-container">
		<div class="contactInfo">
			<div class="box">
				<div class="text">
					<h3>Address</h3>
					<p>47 St. Floral Avenue,<br>Davao City,<br>Philippines</p>
				</div>
			</div>
				<div class="box">
					<div class="text">
